          ...
          <Column className="text-collapse">
            ...
            <FooterLink
              ...
              href={
                process.env.REACT_APP_Explorer +
                "address/" +
                eBTC.networks[process.env.REACT_APP_networkID].address
              }
            >
              {eBTC.networks[process.env.REACT_APP_networkID].address}
            </FooterLink>
            ...
            <FooterLink
              ...
              href={
                process.env.REACT_APP_Explorer +
                "address/" +
                eBTCMarket.networks[process.env.REACT_APP_networkID].address
              }
            >
              {eBTCMarket.networks[process.env.REACT_APP_networkID].address}
            </FooterLink>
            ...
            <FooterLink
              ...
              href={
                process.env.REACT_APP_Explorer +
                "address/" +
                ICO.networks[process.env.REACT_APP_networkID].address
              }
            >
              {ICO.networks[process.env.REACT_APP_networkID].address}
            </FooterLink>
